...
public class Cannon : MonoBehaviour
{
    ...
    private void Movement() //Metodo utilizado para movimentar o carrinho do canh�o no eixo X.
    {
        float x = Input.GetAxis("Horizontal"); //Recebe o Input.

        if (transform.position.x < -maxDistance) //Valida o limite de posi��o do player.
        {
